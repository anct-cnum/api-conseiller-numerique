...
const getCnfsWithoutCRA = async (datePlus1MoisEtDemi, { getCnfsWithoutCRA }) => {
  return Promise.all((await getCnfsWithoutCRA(datePlus1MoisEtDemi)).map(prettifyAndCompleteCnfsWithoutCRA()));
};
