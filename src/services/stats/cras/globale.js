...
const getStatsGlobales = async (db, query, statsCras, isAdminCoop) => {
  ...
  statsGlobales.statsTempsAccompagnements = await statsCras.getStatsTempsAccompagnements(db, query);
  ...
  statsGlobales.statsReorientations = await statsCras.getStatsReorientations(db, query);
