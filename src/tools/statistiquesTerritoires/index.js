    ...
    promiseStructure.push(new Promise(async resolve => {
      ...
      structures.forEach(structure => {
        ...
        depStats.nomDepartement = String(departement.num_dep) === '00' ?
          deps.get(String(structure.codeCommune.substring(0, 3)))?.dep_name : departement.dep_name;
        depStats.nomRegion = String(structure.codeRegion) === '00' ?
          deps.get(String(structure.codeCommune.substring(0, 3)))?.dep_name : departement.region_name;
