...
execute(__filename, async ({ logger, db }) => {
  ...
  logger.info(`${countConseillerAfter} conseiller qui a hubJoined à true dans mongo (avant updateMany)`);
  ...
  logger.info(`${countConseillerBefore} conseiller qui a hubJoined à true dans mongo (Après updateMany)`);
